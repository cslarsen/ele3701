...
\begin{table}[h]
  \centering
  \begin{tabular}{lr}
    Lønnsutgifter (2 personer, 1 år) &  1.700.000 kr \\
    Utstyr                           &     20.000 kr \\
    Tjenere                          &      6.000 kr \\
    Deksel                           &     50.000 kr \\
    Rådgivning                       &    100.000 kr \\
    Godkjenninger                    &    100.000 kr \\
    \textbf{Sum}              & \textbf{1.976.000 kr} \\
  \end{tabular}
...
\begin{table}[h]
  ...
  \begin{tabular}{lrr}
    ...
    Mottakere av alarm & & 4000  \\
    Dekningsgrad alarmenhet  &   &          85\% \\
    Dekningsgrad abonnement  &   &          50\% \\
    Salgspris alarm (inkl. mva.) & & 1.999,00 kr \\
    Salgspris månedsabonnement   & &   199,00 kr \\
    Datasenterkostnad (1000 kunder i ett år)   &  & 155.857,43 kr \\
    \\

    \textbf{Omsetning} &  & \\
    Salg alarmer (eks. mva.)          &          &  6.396.800,00 kr \\
    Årsabonnement alarmer (eks. mva.) &          &  7.641.600,00 kr \\
    \textbf{Sum}                    &  &           14.038.400,00 kr  \\
    \\

    \textbf{Variable kostnader} & & \\
    Produksjon alarmer      &            &    959.520,00 kr \\
    Mobilabonnement alarmer &            &  3.820.800,00 kr \\
    Datasenter og -trafikk  &            &    623.429,73 kr \\
    \textbf{Sum}            &  &            5.403.749,73 kr  \\
    \\

    \textbf{Dekningsbidrag} &  &            8.634.650,27 kr  \\
    \hline
    \\

    \textbf{Faste omkostninger} & & \\
    Lønnsutgifter (5 personer) &         & 4.240.000,00 kr \\
    Leieutgifter kontor        &         &   240.000,00 kr \\
    Internett kontor           &         &     9.588,00 kr \\
    \textbf{Sum}            &  &           4.489.588,00 kr  \\
    \\

    \textbf{Renter} & & \\
    Lån (3 millioner, 4\% rente) &        &   120.000,00 kr \\
    \textbf{Sum}            &  &              120.000,00 kr \\
    \\
    \textbf{Avskrivninger} &  &   \\
    Levetid alarmer (5 år)     &          & 1.279.360,00 kr \\
    PC-er (5 år)               &          &    17.000,00 kr \\
    \textbf{Sum}            &  &            1.296.360,00 kr  \\
    \\
    \textbf{Netto overskudd} &  &           2.728.702,27 kr  \\
    \hline
  \end{tabular}
  \caption{Kostnadsstruktur ved operativ drift for 4000 mottakere.}
\end{table}
