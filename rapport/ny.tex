...
\begin{table}
  ...
  \begin{tabular}{lr}
    ...
    \textit{Ansatte}                                           & 4 \\
    \textit{Brukere}                                           & 4000 \\
    \textit{Pris månedsabonnement (inkl. mva)}            & 199,00 kr \\
    \textit{Kostnad datatrafikk (100 Mb/mnd., inkl. mva.)}   & 49,00 kr \\
    \textit{Kostnad datasenter (1000 brukere/år)}            & 32.913,27 kr \\
    \textit{Kostnad kontorleie (1 $\text{m}^2$/mnd.)}        & 400,00 kr \\
    \\
    \textbf{Omsetning} & \\
