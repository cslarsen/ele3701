...
datamaskiner, og komponentene er billig hyllevare. Salg av elektroniske
konsumentprodukterk krever flere godkjenninger. Dette er ikke så dyrt, men tar
tid.
...
\begin{table}
  ...
  \end{tabular}
  \caption{Kostnader for å utvikle første trygghetsalarm.}
...
\begin{table}
  ...
  \begin{tabular}{lr}
    ...
    Brukere                                           &            4000 \\
    Månedsabonnement (inkl. mva.)                     &       199,00 kr \\
    Kostnad datatrafikk 100 Mb per måned (inkl. mva.) &        49,00 kr \\
    Kostnad datasenter (1000 brukere per år)          &    32.913,27 kr \\
    Leiepris per $\text{m}^2$ per måned
           (gründer-standard)                         &       400,00 kr \\
    \\
    \textbf{Omsetning} & \\
    Inntekt årsabonnement                             & 7.641.600,00 kr \\
    \\
    \textbf{Variable kostnader} & \\
    Datatrafikk alarmer                               & 1.881.600,00 kr \\
    Datasenterkostnader                               &   131.653,07 kr \\
    \textbf{Sum}                                      & 2.013.253,07 kr \\
    \\
    \textbf{Dekningsbidrag}                           & 5.628.346,93 kr \\
    \hline
    \\
    \textbf{Faste kostnader}                       & \\
    Lønnsutgifter (4 personer)                        & 3.392.000,00 kr \\
    Kontor, leie ($30~\text{m}^2$)                    &   144.000,00 kr \\
    Kontor, Internett                                 &     9.588,00 kr \\
    \textbf{Sum}                                      & 3.545.588,00 kr \\
    \\
    \textbf{Avskrivninger}                            & \\
    Datamaskiner kontor (4 stk. over 5 år)            &     9.600,00 kr \\
    \\
    \textbf{Netto overskudd}                          & 2.073.158,93 kr \\
    \hline
  \end{tabular}
  \caption{Kostnad og resultat for ren drift av 4000 brukere.}
  \label{table.drift}
\end{table}

\section{Vekstambisjoner og marked}

Målet vårt er å ta 10\% av markedets på fem år.
...
\begin{table}
  \begin{tabular}{lrrrrr}
   & \textbf{1.~år} & \textbf{2.~år} & \textbf{3.~år} & \textbf{4.~år} & \textbf{5.~år} \\
    ...
    Datasenterkostnad               &    16 &   49 &   82 &   132 &   230 \\
