...
opp og stenge ned virtuelle tjenere i takt med trafikkmengden.
...
kompleksiteten flyttes over til tjenere i skyen \cite{mobil.virt.fordel}.

Vår forretningsidé er å tilby en totalløsning for \textit{mobile tynnklienter}.
%
Dette betyr at hele mobiltelefonen vil kjøre som et program på en tjener og
gjøres tilgjengelig for sluttbrukeren gjennom en dum terminal som
videreformidler brukerinteraksjon.

For å redusere omfanget og komme raskt på markedet skal vi fokusere på å
utvikle systemet gjennom et nisjeprodukt: En trygghetsalarm for eldre.
%

Mens eksisterende produkter krever en hussentral vil vår løsning kunne brukes
både hjemme og ute.
%
Alarmen vil da kjøre på en generell platform som kan spesialtilpasses formålet
ved å låses til å kjøre et spesifikt program på tjenersiden.
%
På denne måten kan vi tilby billige, energieffektive og brukervennlige
produkter i en rekke nisjekategorier.

Når løsningen blir moden vil vi på sikt tilby tilsvarende tynnklientløsninger
for mobiltelefoner, smartklokker og nettbrett.
