...
\begin{table}
  ...
  \begin{tabular}{lr}
    ...
    % TODO:!!!!!!!!!!! Legge til flere kostnader her!!!!
    \textbf{Sum}                                      & 3.545.588,00 kr \\
    \\
    \textbf{Driftsresultat før avskrivninger}         & 2.082.758,94 kr \\
    \hline
    \\
    \textbf{Avskrivninger}                            & \\
    Datamaskiner kontor (4 stk. over 5 år)            &     9.600,00 kr \\
    \\
    \textbf{Årsoverskudd}                             & 2.073.158,93 kr \\
    \hline
  \end{tabular}
  \caption{Driftsbudsjett for 4000 brukere \textit{uten} salg av nye alarmer.}
  \label{table.drift}
\end{table}
