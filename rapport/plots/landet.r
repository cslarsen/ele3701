...
plot(total$År, total$Personer / 1000, xlab="År", ylab="Personer
     (tusen)",type="b", main="Mottakere hele året")

plot(nye$År, nye$Personer / 1000, xlab="År", ylab="Personer (tusen)", type="b",
     main="Nye mottakere")

plot(gjstr$År, gjstr$Personer / 1000, xlab="År", ylab="Personer (tusen)",
     type="b", main="Mottakere hele eller deler av året")
...
legend(2010,105,c(">= 67 år", "< 67 år"), pch=c(3,1))
